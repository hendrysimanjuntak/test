...
namespace TBIGDocumentGenerator.Application.Interfaces.Entities.TBGAPPHFIRE141.TBIGDocumentGenerator
{
    public interface IExcelWorksheetService : IBaseService<ExcelWorksheet>
    {
    }
}
